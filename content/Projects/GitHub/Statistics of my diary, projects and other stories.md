The repository is named [statistics-diary](https://github.com/kreier/statistics-diary) on Github. One day I want to have a few statistics to quantizise my notes. For example i would like to have the following key parameters:
...
The five sources should be parsed and the information put into CSV files. The key for each table is the date in the YYYY-MM-DD format. This way I can create the Github like overview with tooltips when hovering. Color scheme:
